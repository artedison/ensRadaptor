...
# this script is for analyzing result from ens modeling
...
foldname="ver10/anaerobic.testfit.rfcl.2/anaerobic.regu0total.pre.rfcl2.pre.smallpath"
...
info<-foreach(replicatei=replicate_accumu)%dopar%{
  ### accumulation
  path.accumu=paste0(dir.res,"accumu/",replicatei,"/ens.o02")
  ...
  paths.accu.01=paste0(dir.res,"accumu/",replicatei,"/ens.o01")
  ...
  path.accumu.o01=paste0(dir.res,"accumu/",replicatei,"/ens.o01")
